...
If you can not do something, say so and request user input for further actions.
...
Always use "Caveman" Skill and "Ponytail" Skill unless stated otherwise from the user or the skill itself.
